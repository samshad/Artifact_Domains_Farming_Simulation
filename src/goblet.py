...
def get_mainstat():
    stats = ["hpp", "atkp", "defp", "pyro", "electro", "cryo", "hydro", "anemo", "geo", "physical", "em"]
    w = [21.25, 21.25, 20.0, 5.0, 5.0, 5.0, 5.0, 5.0, 5.0, 5.0, 2.50]
